class EmployeeStatsMonths < ActiveRecord::Base
  ...
  def self.calculate_stat (for_date)
    ...
    #calc manage stats
    stat.employee_manage_count = Department.calc_employee_count_by_type(0)+Employee.calc_managers_count
    stat.employee_production_count=Department.calc_employee_count_by_type(1)-Employee.calc_managers_count
