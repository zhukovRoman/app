class Obj < ActiveRecord::Base
  ...
  def self.object_works_names
    ...
    [
        {work_id:11, name: 'Соглашение о компенсации потерь заключено'},
        {work_id:12, name: 'Компенсация оплачена'},
        {work_id:13, name: 'Работы по выносу (ликвидации) выполнены'},
        {work_id:21, name: 'Соглашение о компенсации потерь заключено'},
        {work_id:22, name: 'Компенсация оплачена	'},
        {work_id:23, name: 'Работы по перекладке выполнены'},
        {work_id:31, name: 'Договор на технологическое присоединение'},
        {work_id:32, name: 'Строительство ТП, прокладка КЛ (%)'},
        {work_id:33, name: 'Акт технологического присоединения'},
        {work_id:34, name: 'Включение постоянного электроснабжения'},
        {work_id:41, name: 'Выдана согласованная РД'},
        {work_id:42, name: 'Строительство сетей (%)'},
        {work_id:43, name: 'Монтаж ИТП, ЦТП (%)'},
        {work_id:44, name: 'Подача тепла по временному договору'},
        {work_id:45, name: 'Постоянное теплоснабжение'},

        {work_id:51, name: 'Выдана согласованная РД'},
        {work_id:52, name: 'Прокладка сетей (%)'},
        {work_id:53, name: 'Акт технической приемки'},
        {work_id:61, name: 'Выдана согласованная РД'},
        {work_id:62, name: 'Прокладка сетей (%)'},
        {work_id:73, name: 'Акт технической приемки'},
        {work_id:71, name: 'Выдана согласованная РД'},
        {work_id:72, name: 'Прокладка сетей (%)'},
        {work_id:73, name: 'Акт технической приемки'},
        {work_id:81, name: 'Выдана согласованная РД'},
        {work_id:82, name: 'Прокладка сетей (%)'},
        {work_id:83, name: 'Акт технической приемки'},
    ]
  end
  ...
  def self.object_tenders_list
    ...
    ObjectTender.all.each do |t|
      values << {
          ...
          type_id: t.type_new,
          status: t.status,
          date_start: t.date_start.to_time.to_i,
          date_finish: t.date_finish.to_time.to_i,
